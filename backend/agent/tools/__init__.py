...
按 TOOL_CATEGORIES 分组为子包（poi / plan / driving）：
...
RAG 工具（search_rag）已于 2026-08-08 移除：项目文档查询对非技术用户无意义、
技术人员直接看 GitHub，RAG 留待未来 raw_data 清洗；BM25 引擎
（infrastructure/retrieval/bm25.py）保留供未来复用。
...
# 子包目录结构与本表一一对应（poi/plan/driving）。
