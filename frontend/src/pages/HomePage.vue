  ...
  <div class="page-home">
    ...
    <section class="form-section">
      ...
      <div class="form-row">
        ...
        <n-button secondary :disabled="!canSearchHotel || loading" :loading="loading" @click="searchHotel">
          🏨 搜索酒店坐标
        </n-button>
      </div>
    ...
    <section class="form-section">
      <h3>景点名称</h3>
      <div class="form-row">
        <n-input v-model:value="spotText" type="textarea" :rows="6" placeholder="每行一个景点&#10;故宫&#10;颐和园&#10;天坛" />
        <n-button secondary class="btn-self-start" :disabled="!canSearchSpots || loading" :loading="loading" @click="searchSpots">
          🔍 搜索景点坐标
        </n-button>
      </div>
