...
export function postSuggest(data: PlanRequestPayload): Promise<{ suggestions: SuggestionItem[]; algo_time?: number; amap_api_key?: string; spots?: Record<string, SpotDictItem>; cost_matrix?: number[][]; dist_matrix?: number[][]; message?: string }> {
