...
def api(path, data):
    req = urllib.request.Request(
        f"{BASE}{path}", data=json.dumps(data).encode(), headers={"Content-Type": "application/json"}, method="POST"
    )
...
spots = [
    ...
    for i, (stay, exp) in enumerate(
        [(180, 480), (120, 960), (150, None), (60, None), (300, 480), (60, None), (120, None), (120, None)],
        1,
    )
]
